...
<div class="content">
    ...
    <form action="insert_proveedor.php" method="post" class="mb-4">
        <div class="form-grid">
    <!-- Columna Izquierda -->
    <div class="form-column">
        <div class="form-group-modern">
            <label class="form-label">Código</label>
            <input type="text" class="form-input" name="prov_codigo" required>
        </div>

        <div class="form-group-modern">
            <label class="form-label">Nombre</label>
            <input type="text" class="form-input" name="prov_nombre" required>
        </div>

        <div class="form-group-modern">
            <label class="form-label">Teléfono</label>
            <input type="text" class="form-input" name="prov_telefono" required>
        </div>

        <div class="form-group-modern">
            <label class="form-label">Email</label>
            <input type="email" class="form-input" name="prov_correo" required>
        </div>
    </div>
    ...
    <div class="form-column">
        <div class="form-group-modern">
            ...
            <input type="text" class="form-input" name="prov_direccion" required>
        </div>

        <div class="form-group-modern">
            <label class="form-label">NIT</label>
            <input type="text" class="form-input" name="prov_nit" required>
        </div>

        <div class="form-group-modern">
            <label class="form-label">Categoría</label>
            <input type="text" class="form-input" name="prov_categoria" required>
        </div>
    </div>
</div>
